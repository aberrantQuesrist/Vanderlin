/datum/job/roguetown/magician
	...
	tutorial = "Dream interpreter, soothsayer, astrologer and valued courtier, blessed by the arcyne dieties. \
...
/datum/outfit/job/roguetown/magician/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		if(H.patron != /datum/patron/divine/noc || H.patron != /datum/patron/inhumen/zizo)
